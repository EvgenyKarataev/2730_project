...
<body>
	...
	<div class="row" id="header">
		...
		<div id="controlBtns">
			...
			<div class="controlBtn" id="formatBtn">
				<i class="icon-list"></i> 
				<span class="btnText">Format</span>
			</div>
		...
		<div class="controlBtn" id="loginContainer">
			<i class="icon-signin"></i>
			<span class="btnText">Login/Signup</span>
		</div>
	</div>
	...
	<div class="row" id="content">
		...
		<div class="span6 contentPane" id="middleCP">
		</div>
